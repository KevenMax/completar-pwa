...
Curso.create(nome: 'Engenharia de Software', campu_id: 1)
...
Categoria.create(nome: 'Atividades de iniciação à docência, à pesquisa e/ou à extensão', limite_carga_horaria: 96.0, curso_id: 1)
Categoria.create(nome: 'Atividades artístico culturais e esportivas', limite_carga_horaria: 80.0, curso_id: 1)
Categoria.create(nome: 'Atividades de participação e/ou organização de eventos', limite_carga_horaria: 32.0, curso_id: 1)
Categoria.create(nome: 'Experiências ligadas à formação profissional e/ou correlatas', limite_carga_horaria: 64.0, curso_id: 1)
Categoria.create(nome: 'Produção Técnica e/ou Científica', limite_carga_horaria: 96.0, curso_id: 1)
Categoria.create(nome: 'Vivências de gestão', limite_carga_horaria: 48.0, curso_id: 1)
Categoria.create(nome: 'Outras atividades', limite_carga_horaria: 48.0, curso_id: 1)
